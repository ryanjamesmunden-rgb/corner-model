...
import {
  ArrowLeft, TrendingUp, TrendingDown, Flame, Shield, MapPin, Swords, Eye,
} from "lucide-react";
...
// How reliable a hit rate is, is an ORDINAL question, so the top two bands are one hue at
// two intensities rather than two different colours — cyan used to sit in the middle of
// this ladder, which spent the brand colour on a status and made "playable" look like a
// button. Amber then marks the point where the evidence gets thin, matching what amber
// means everywhere else on the site, and the bottom band recedes entirely.
const band = (pct) =>
...
export default function FixtureDetail() {
  ...
  return (
    <div className="space-y-3 sm:space-y-6" data-testid="fixture-detail-page">
      ...
      {/* The headline answer, drawn. This sits ABOVE the market tables on purpose: it is
          the one thing a visitor who has never used the site can read, and the tables are
